...
export const compileScheduledWorkflowDefinition = (
  ...
  const lines = [
    ...
    'Treat extracted or structured source data from earlier steps as the execution source of truth for later steps.',
    ...
    'Either keep executing the workflow steps now, stop for a real approval gate, or report a true hard block.',
    'Do not treat setup-only progress like reading a file or parsing a list as final completion when downstream execution steps still remain.',
