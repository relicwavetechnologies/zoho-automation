...
export const searchAgent = new Agent({
  ...
  instructions: withChatResponseFormatting(`You are a Web Intelligence Specialist tasked with retrieving and distilling real-time information from the external web.
