...
class TestSearXNGOnlyExtractCrawlErrors:
    """When searxng is the active backend (search-only), web_extract falls back
    to the free built-in 'native' extractor instead of erroring."""
    ...
    def test_web_extract_searxng_falls_back_to_native(self, monkeypatch):
        import asyncio
        from tools import web_tools
