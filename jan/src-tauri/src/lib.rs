...
macro_rules! invoke_commands_with_extras {
    ($($extra:path),* $(,)?) => {
        ...
        core::divo::commands::divo_shopify_authorize_url,
        core::divo::commands::divo_shopify_status,
        core::divo::commands::divo_shopify_manage_access,
        core::divo::commands::divo_shopify_grant_access,
        core::divo::commands::divo_shopify_revoke_access,
        core::divo::commands::divo_shopify_disconnect_connection,
