...
export class Theme {
	...
	getThinkingBorderColor(level: ThinkingLevel | "off"): (str: string) => string {
		...
		switch (level) {
			...
			case "xhigh":
			// Shares xhigh's colour rather than falling through to the `off`
			// default below, which would paint the most reasoning like none.
			case "max":
