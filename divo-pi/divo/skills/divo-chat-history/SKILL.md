...
description: Search and read past Divo/Pi sessions in this runtime. Use when the user asks about prior decisions, earlier debugging, previous chats, or "what did we do before".
---
