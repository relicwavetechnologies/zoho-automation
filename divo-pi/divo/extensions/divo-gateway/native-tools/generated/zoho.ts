...
export const ZOHO_NATIVE_TOOLS = [
  ...
  },
  {
    ...
    "promptGuidelines": [
      ...
      "read params: invoiceId, accountId, searchQuery, dateFrom, dateTo, status, taxYear, limit (1-200), page (1-100)",
