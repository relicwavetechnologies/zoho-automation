...
/**
 * Must sit above the page ceiling so an oversized page reports the specific
 * page-size error rather than a generic protocol overflow.
 */
const MAX_PROTOCOL_BYTES = MAX_PAGE_BYTES * 2;
