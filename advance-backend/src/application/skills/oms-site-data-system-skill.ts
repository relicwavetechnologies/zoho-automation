...
10. Summarize only the useful evidence in chat. The preview contains at most 25 rows. OMS has no pagination contract, so any created artifact can contain only the bounded returned snapshot and must say that it may not be exhaustive.
