...
- Choose \`final_amount\`, \`collectable_value\`, or \`declared_value\` from the member's wording. State the selected meaning when material, and ask one short question only when genuinely ambiguous.
