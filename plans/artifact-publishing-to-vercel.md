...
- The panel state also clears a previously published URL when a newer revision arrives, matching the repository's publication reset; this regression is covered by the artifact store test.
