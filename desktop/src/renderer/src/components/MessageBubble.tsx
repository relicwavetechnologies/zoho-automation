    ...
    <div className="group mb-8 last:mb-0">
      ...
      >
        ...
        >
          ...
          {isUser ? (
            <div className="group/user relative inline-block w-fit max-w-full rounded-3xl bg-secondary/40 px-5 py-3.5 border border-border/50 shadow-sm mt-1 mb-1">
              <p className="text-[14px] leading-[1.6] text-foreground/90 whitespace-pre-wrap text-left [overflow-wrap:anywhere]">
                {displayContent}
              </p>
