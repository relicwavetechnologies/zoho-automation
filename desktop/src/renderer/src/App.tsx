      ...
      return (
        <div className="flex h-full items-center justify-center bg-[hsl(0_0%_4%)] px-6">
          <div className="w-full max-w-3xl rounded-2xl border border-[hsl(0_52%_28%)] bg-[hsl(0_38%_12%)] p-6 text-[hsl(0_0%_92%)] shadow-2xl">
            <h1 className="text-lg font-semibold text-[hsl(0_85%_78%)]">
              Frontend exception
            </h1>
            <p className="mt-2 text-sm text-[hsl(0_0%_82%)]">
              The renderer crashed while rendering this screen. The exact error
              was captured in the frontend debug log and browser console.
            </p>
            ...
            <p className="mt-4 text-xs text-[hsl(0_0%_68%)]">
              Check DevTools console or localStorage key{" "}
              <code>divo_frontend_debug_log</code>, then reload the desktop app
